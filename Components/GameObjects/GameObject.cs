...
namespace Game.Components.GameObjects
{
    public abstract class GameObject
    {
        ...
        public GameObject(RenderObject model, Vector4 position, Vector4 direction, Vector4 rotation, float velocity)
        {
            _model = model;
            _position = position;
